...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "after:absolute after:inset-0 after:rounded-2xl after:bg-gradient-to-tr after:from-transparent after:to-white/5 after:z-[-1]",
      "hover:border-white/20 hover:bg-white/10 hover:shadow-white/10 transition-all duration-300",
      className
    )}
    {...props}
  />
